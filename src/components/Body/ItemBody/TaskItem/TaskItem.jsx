...
import edit from '../../../../assets/icons/changeSvg.svg'
import remove from '../../../../assets/icons/removeIcon.svg'

export const TaskItem = ({id, text, onRemoveTask, idList}) => {
	...
	return (
		<div className='item-task__row'>
			...
			<form className='item-task__form'
				...
				<div className='item-task__block-btn'>
					{editMode
					...
					<svg width="15" height="15" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg"
							 className='item-task__close' onClick={() => onRemoveTask(idList, id)}>
						<path
