...
export const ControlButtons = ({editMode, doneEdit, cancelEditMode, onRemoveTask, idList, id, setEditMode, visible}) => {
	let btnShowStyle = 'control-btn'
	if (visible) btnShowStyle += ' active'

	return (
		<div className={`control-btn ${btnShowStyle}`}>
			{editMode
